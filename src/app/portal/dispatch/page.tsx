...
const GUIDE_TYPES = [
  {
    ...
    description: 'Movimiento de mercadería sin transacción comercial. No incluye precios.',
    icon: (
  ...
  },
  {
    id: 'national',
    name: 'Venta Nacional',
    description: 'Despacho con precio real o precio fijo ($50) según el cliente.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    id: 'export',
    name: 'Exportación',
    description: 'Guía para envío al exterior vía agencia de aduana. Se enlaza con la Orden de Venta.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Seleccione el tipo de guía que desea generar
        </p>
      </div>
