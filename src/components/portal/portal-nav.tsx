      ...
      {mobileMenuOpen && (
        <div className="sm:hidden border-t border-slate-700/50 bg-slate-800/50">
          <div className="px-4 py-4 space-y-3">
            ...
            <Link
              href="/portal/invoices"
              className="flex items-center gap-2.5 text-slate-300 hover:text-white px-3 py-2.5 rounded-lg hover:bg-slate-700/50 text-sm font-medium transition-colors"
            ...
            <button
              onClick={handleLogout}
              className="flex items-center gap-2.5 text-slate-400 hover:text-red-400 px-3 py-2.5 rounded-lg hover:bg-slate-700/50 text-sm font-medium transition-colors w-full text-left"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
